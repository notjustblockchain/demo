...
class ProjectResourceIT {
    ...
    public static Project createEntity(EntityManager em) {
        Project project = new Project().projectCode(DEFAULT_PROJECT_CODE).status(DEFAULT_STATUS);
        return project;
    }
    ...
    public static Project createUpdatedEntity(EntityManager em) {
        Project project = new Project().projectCode(UPDATED_PROJECT_CODE).status(UPDATED_STATUS);
        return project;
    }
    ...
    void putNewProject() throws Exception {
        ...
        updatedProject.projectCode(UPDATED_PROJECT_CODE).status(UPDATED_STATUS);
    ...
    void fullUpdateProjectWithPatch() throws Exception {
        ...
        partialUpdatedProject.projectCode(UPDATED_PROJECT_CODE).status(UPDATED_STATUS);
